...
class PhotoEditor:
    def __init__(self, root):
        ...
        self.canvas.grid(row=0, column=0, columnspan=10, rowspan=40, sticky='nsew')

        self.h_scroll = Scrollbar(root, orient='horizontal', command=self.canvas.xview)
        self.h_scroll.grid(row=42, column=0, columnspan=10, sticky='ew')
